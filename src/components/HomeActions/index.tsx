  ...
  return (
    <div className="flex flex-wrap text-gray-500">
      <span className="flex items-center space-x-6 pb-2 pr-6">
        <Link className="site-link" to="editors-pick">editor's pick</Link>
        <Link className="site-link" to="write-for-us">write for us</Link>
        <Link className="site-link" to="about">about</Link>
        <span className="h-4 border-l border-solid border-gray-300"></span>
      </span>
      <span className="flex items-center pb-2">
        <Link className="site-link pr-6" to="subscribe">subscribe</Link>
